...
filenames= ['ISMF_zpyc_'+loc+'_50-150_zlim-500-10',
            'ISMF_zpyc_'+loc+'_50-150_zlim-4500--3500'
...
#wed.pycnocline_depth_t(yr,run_list=run,region=loc,plot_histogram=False,zlim=zlim_deep,write_headings=False)
...
#wed.plot_zpyc_t(filenames,run=run,tlim=[50,150],placename=['on-shelf','off-shelf'],plot_difference = True,cutoff=0)
